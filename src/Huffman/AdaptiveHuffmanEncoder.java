 ...
 * <p>Usage: java AdaptiveHuffmanEncoder InputFile OutputFile</p>
 * <p>Then use the corresponding "Huffman.AdaptiveHuffmanDecoder" application to recreate the original input file.</p>
 ...
 */
public final class AdaptiveHuffmanEncoder {
	...
	public static void main(String[] args) throws IOException {
		...
		if (args.length != 2) {
			System.err.println("Usage: java AdaptiveHuffmanEncoder InputFile OutputFile");
			System.exit(1);
			return;
		}
