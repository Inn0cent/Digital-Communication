 ...
 * <p>Usage: java Huffman.AdaptiveHuffmanDecoder InputFile OutputFile</p>
 * <p>This decompresses files generated by the "AdaptiveHuffmanEncoder" application.</p>
 */
public final class AdaptiveHuffmanDecoder {
	
	// Command line main application function.
	public static void main(String[] args) throws IOException {
		// Handle command line arguments
		if (args.length != 2) {
			System.err.println("Usage: java Huffman.AdaptiveHuffmanDecoder InputFile OutputFile");
			System.exit(1);
			return;
		}
